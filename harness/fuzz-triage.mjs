...
const TOKENS_MD = ["*","**","***","_","__","~~","==","^^","`","``","[[","]]","((","))","{{","}}","[","]","(",")","{","}","#","#tag","[[Foo]]","((11111111-1111-1111-1111-111111111111))","[label]","](url)","{{embed ","{{query ","https://x.com/a","http://y.org","\\","\\[","\\#","\\`","$","$x$","$$","!","![a]","<",">","<https://z.io>","a","b"," ","  ","\n","café","中文","😀",".",",","!",":","-","/","TODO ","[#A] ","[ ] ","\t","word","x","#[[","tag","::"];
...
const inputs = []; for (let i=0;i<N;i++) inputs.push({ id:`t${i}`, input: gen(), format: FORMAT });
